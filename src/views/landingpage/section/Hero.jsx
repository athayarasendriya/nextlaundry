      ...
      <div className={`w-full xl:px-0 sm:px-16 px-6 space-x-20`} >
        <div className={`flex flex-row justify-start items-center`}>
          ...
          <div className={`flex flex-col font-poppins font-semibold z-20 ml-10`}>
            ...
            <p className={`pt-5 text-2xl ${styles.paragraph2} container w-3/4`}>
              Lorem ipsum dolor sit amet consectetur. Purus tempus tincidunt massa laoreet in non.
            </p>
            <div className={`border-4 rounded-none border-black p-5 container w-1/4 text-center hover:bg-magentas hover:cursor-pointer`}>
              <a href="" className='text-black font-medium'>Discover More!</a>
            </div>
          </div>
        </div>
      </div>
